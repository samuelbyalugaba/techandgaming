        ...
        <Card>
          ...
          <CardContent>
            ...
            <Button size="sm" className="mt-4" asChild>
                <Link href="/management/games">Manage Games <ArrowUpRight className="h-4 w-4 ml-2" /></Link>
            </Button>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
             ...
             <Button size="sm" className="mt-4" asChild>
                <Link href="/management/blog">Manage Posts <ArrowUpRight className="h-4 w-4 ml-2" /></Link>
            </Button>
          </CardContent>
        </Card>
      </div>
